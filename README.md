...
This is a sample template for stockcode-scraping - Below is a brief explanation of what we have generated for you:

```bash
.
├── README.md                   <-- This instructions file
├── stockcode-scraping                 <-- Source code for a lambda function
